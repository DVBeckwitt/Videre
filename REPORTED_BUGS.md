...
- **Audit finding fixed in Videre 1.22.19**: found during source review rather
  than filed as an upstream issue.
- **Build-verified candidate mitigation in Videre 1.22.19; runtime verification
  pending**: release artifacts contain the mitigation, but affected and control
  device behavior has not been confirmed.
